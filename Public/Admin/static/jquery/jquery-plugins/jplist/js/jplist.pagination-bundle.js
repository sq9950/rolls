...
(function () {
    var f = function (d, b, a) {
            var e;
            e = '<div class="jplist-pagesbox" data-type="pagesbox"><input name="" vlaue="" type="text" style="margin:10px;width:80px;" placeholder="跳转到.."  class="jplist-jump-dest" />';
...
(function () {
    ...
    jQuery(document).on('keypress', '.jplist-jump-dest', function(event){
        if(13 == event.which){
            var page_num = Math.max(Number(jQuery(this).val() - 1) || 0, 0);
