...
if (extension_loaded('mbstring')) {
	...
	function utf8_substr($string, $offset, $length = null, $overflow = '...') {
		if ($length === null) {
			return mb_substr($string, $offset, utf8_strlen($string));
		} else {
			if($overflow && utf8_strlen($string) > $length){
				return mb_substr($string, $offset, $length).$overflow;
			}
	...
	function utf8_substr($string, $offset, $length = null, $overflow = '...') {
		if ($length === null) {
			...
			if($overflow && utf8_strlen($string) > $length){
				return iconv_substr($string, $offset, $length, 'UTF-8').$overflow;
			}
