...
final class PersistentFop
{
    ...
    public function execute($key, $fops)
    {
        ...
        \Library\Qiniu\setWithoutEmpty($params, 'pipeline', $this->pipeline);
        \Library\Qiniu\setWithoutEmpty($params, 'notifyURL', $this->notify_url);
        if ($this->force) {
            $params['force'] = 1;
        }
