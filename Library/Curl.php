...
class Curl {
    ...
    **/
    protected function set_request_options($url, $vars) {
		...
		curl_setopt($this->request,CURLOPT_TIMEOUT, 10);//执行超时设置
        curl_setopt($this->request, CURLOPT_CONNECTTIMEOUT, 30);//连接超时设置
        curl_setopt($this->request, CURLOPT_HEADER, true);
        curl_setopt($this->request, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($this->request, CURLOPT_USERAGENT, $this->user_agent);
        if ($this->cookie_file && $this->cookiefileswitch === 'on') {
    ...
    /*
     * add gaolu@yundun.com
     */
    public function set_request_option($name, $value){
